...
impl DedupStore {
    pub fn new(
        ...
        DedupStore {
            ...
            upload_normal_size: normal_size,
...
impl StoreTrait for DedupStore {
    ...
    fn update<'a>(
        ...
        Box::pin(async move {
            ...
            let est_spawns = input_max_size / (self.upload_normal_size as f64 * 1.5) as usize;
    ...
    fn get_part<'a>(
        ...
        Box::pin(async move {
            ...
            let index_entries = {
                ...
                // We estimate the number of slices we need and add 30% because the estimate is not super accurate.
                let est_parts = digest.size_bytes as usize / (self.upload_normal_size as f64 * 1.3) as usize;
